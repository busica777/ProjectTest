...
public class CommonMethods extends PageInitializer {
    ...
    public static void openBrowserAndLaunchApplication() {
        ...
        initializePageObjects();//call the method to use it
    ...
    public static void closeBrowser() { //this method we write to use/call it later, right now we didn't
        Log.info("My test case is about to complete");
        Log.endTestCase("This is my login test again");
        driver.quit();
    }

    //we need to clear the before data and then  sendKeys
    ...
    public static WebDriverWait getWait() {//return the proper wait to be used anywhere else
    ...
    //selecting the dropdown,using text ---------- we have 3 ways:by  index, by value, by text
